...
namespace utl {
	...
	public:
		...
		virtual CVarInfo* createFloatCVar(std::string_view name, std::string_view description, 
		...
		virtual CVarInfo* createIntCVar(std::string_view name, std::string_view description, 
										int64_t initial, CVarFlags flags = CVarFlags::None,
										int64_t min = std::numeric_limits<int64_t>::min(),
										int64_t max = std::numeric_limits<int64_t>::max()) = 0;
		virtual CVarInfo* createBoolCVar(std::string_view name, std::string_view description, 
										 bool initial, CVarFlags flags = CVarFlags::None) = 0;
		virtual CVarInfo* createStringCVar(std::string_view name, std::string_view description, 
										   std::string_view initial, CVarFlags flags = CVarFlags::None) = 0;

		virtual CVarInfo* createVec2CVar(std::string_view name, std::string_view description, 
										 Vec2 initial, CVarFlags flags = CVarFlags::None,
										 double min = std::numeric_limits<double>::min(), double max = std::numeric_limits<double>::max()) = 0;
		virtual CVarInfo* createVec3CVar(std::string_view name, std::string_view description, 
										 Vec3 initial, CVarFlags flags = CVarFlags::None,
										 double min = std::numeric_limits<double>::min(), double max = std::numeric_limits<double>::max()) = 0;

		virtual CVarInfo* createVec4CVar(std::string_view name, std::string_view description, 
	...
	{
		AutoCVar_Float(std::string_view name, double initial,
	...
	{
		AutoCVar_Int(std::string_view name, int64_t initial , 
					 std::string_view description="", CVarFlags flags = CVarFlags::None,
					 int64_t min = std::numeric_limits<int64_t>::min(),
	...
	{
		AutoCVar_Bool(std::string_view name, bool initial,  std::string_view description="" ,CVarFlags flags = CVarFlags::None);
	...
	{
		AutoCVar_String(std::string_view name, std::string_view initial, std::string_view description="",CVarFlags flags = CVarFlags::None);
	...
	{
		AutoCVar_Vec2(std::string_view name, CVarSystem::Vec2 initial,  std::string_view description="",CVarFlags flags = CVarFlags::None,
					  double min = std::numeric_limits<double>::min(), double max = std::numeric_limits<double>::max());
	...
	{
		AutoCVar_Vec3(std::string_view name, const CVarSystem::Vec3& initial,  std::string_view description="",CVarFlags flags = CVarFlags::None,
					  double min = std::numeric_limits<double>::min(), double max = std::numeric_limits<double>::max());
	...
	{
		AutoCVar_Vec4(std::string_view name, const CVarSystem::Vec4& initial, std::string_view description="", CVarFlags flags = CVarFlags::None,
					  double min = std::numeric_limits<double>::min(), double max = std::numeric_limits<double>::max());
